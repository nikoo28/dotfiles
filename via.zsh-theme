...
set_default OHMYVIA_CONTEXT_HOSTNAME         "partial"
set_default OHMYVIA_CONTEXT_HOSTNAME_COLOR   "%B%F{green}"
...
set_default OHMYVIA_DIR_COLOR                "$FG[202]"
set_default OHMYVIA_DIR_SIZE                 "0"

set_default OHMYVIA_STATUS_OK_COLOR          "%B%F{green}"
set_default OHMYVIA_STATUS_ERROR_COLOR       "$FG[196]"
...
PROMPT='$FG[237]${(l.COLUMNS..-.)}%{$reset_color%}[$(prompt_context) $(prompt_dir) $(prompt_time)]${OHMYVIA_EOL}'
